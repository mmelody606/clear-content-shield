...
const FreeTrialSection = () => {
  return (
    <section className="py-16 px-4 md:px-6 lg:px-8 bg-white">
      <div className="max-w-5xl mx-auto bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-8 md:p-12">
        ...
        <div className="max-w-3xl mx-auto bg-white rounded-xl shadow-sm p-6 md:p-8">
          ...
          <div className="flex justify-center gap-4">
            <Button size="lg">Check Plagiarism</Button>
            <Button size="lg" variant="outline">Detect AI Content</Button>
          </div>
